...
function ProductCard({product}: {product: Product}) {
  return (
    <div className="max-w-sm w-full bg-white rounded-lg shadow-md overflow-hidden flex flex-col hover:shadow-2xl transition-all hover:scale-[1.01]">
      <Link href={"product-details/" + product.id.toString()}>
